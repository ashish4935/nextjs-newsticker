    ...
    class="my-12 h-px border-t-0 bg-transparent bg-gradient-to-r from-transparent via-gray-300 to-transparent opacity-25 dark:opacity-100" />
        <div className="flex flex-col space-y-3 items-center justify-center py-3 text-gray-300">
            ...
            <div class="flex flex-1">
                <p class="pr-3"><Link href="/privacy-policy">Privacy Policy</Link></p>
                <div
                    class="h-[25px] min-h-[1em] w-px self-stretch bg-gradient-to-tr from-transparent via-neutral-500 to-transparent opacity-20 dark:opacity-100">
                </div>
                <p class="pl-3"><Link href="/disclaimer">Disclaimer</Link></p>
            </div>
        </div>
    </footer>
  )
