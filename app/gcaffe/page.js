  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 px-12 pt-24">
        ...
        <div className="py-8 flex items-center justify-center relative img-parent">
          ...
          <Image src='/GCaffe_Archives.webp' alt="Bharat Bolega" width={300} height={300} className="absolute top-0 left-0 img-child"/>
          <Image src='/GCaffe_Articles.webp' alt="Bharat Bolega" width={250} height={250} className="absolute bottom-0 right-0 img-child2"/>
        </div>
    </div>
  )
}
